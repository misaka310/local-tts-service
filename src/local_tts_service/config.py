...
DEFAULT_CONFIG = {
    ...
    "models": {
        ...
        "fish_s2_pro": {
            ...
            "supportsSeed": True,
            "defaultLanguage": "ja",
            "externalCommandKey": "fish_s2_pro",
            "chunking": {"softChunkChars": 120, "maxChunkChars": 180, "hardLimitChars": 240, "pauseBetweenChunksMs": 250},
            "notes": "Fish S2 Pro。公式は24GB以上のGPUメモリを推奨。S1-miniとは分離した環境です。",
        },
        "indextts_2_5": {
            "runtime": "external_cli",
            "label": "IndexTTS 2.5",
            ...
            "supportsSpeedControl": True,
            "defaultLanguage": "ja",
            "externalCommandKey": "indextts_2_5",
            "chunking": {"softChunkChars": 120, "maxChunkChars": 180, "hardLimitChars": 240, "pauseBetweenChunksMs": 250},
            "notes": "参照WAVのみで日本語の声寄せ。ネイティブ話速制御に対応。",
        },
        "orpheus_3b_asmr": {
            "runtime": "external_cli",
    ...
    "runtimes": {
        ...
        "external_cli": {
            ...
            "commands": {
                ...
                "fish_s2_pro": ["powershell", "-NoProfile", "-File", "./scripts/run-wsl-tts.ps1", "-RequestJson", "{request_json}", "-OutputPath", "{output_path}"],
                "indextts_2_5": ["powershell", "-NoProfile", "-File", "./scripts/run-wsl-tts.ps1", "-RequestJson", "{request_json}", "-OutputPath", "{output_path}"],
            ...
            "availabilityCommands": {
                ...
                "fish_s2_pro": ["powershell", "-NoProfile", "-File", "./scripts/check-wsl-tts.ps1", "-Model", "fish_s2_pro"],
                "indextts_2_5": ["powershell", "-NoProfile", "-File", "./scripts/check-wsl-tts.ps1", "-Model", "indextts_2_5"],
